...
{
    public function test_new_image()
    {
        // Arrange
    ...
    public function test_old_image()
    {
        ...
        $keys = ['Id' => ['N' => '101']];
        $oldImage = [
            'Message' => ['S' => 'This item has been deleted'],
            'Id' => ['N' => '101'],
        ];
        $eventName = 'REMOVE';
        ...
        $this->assertSame($oldImage, $record->getOldImage());
        $this->assertSame('333', $record->getSequenceNumber());
        $this->assertSame(38, $record->getSizeBytes());
        $this->assertSame('OLD_IMAGE', $record->getStreamViewType());
    }
