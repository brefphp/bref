...
# Default Extensions
RUN cp /opt/remi/php80/root/lib64/php/modules/ctype.so /bref/php-modules/ctype.so
RUN cp /opt/remi/php80/root/lib64/php/modules/exif.so /bref/php-modules/exif.so
RUN cp /opt/remi/php80/root/lib64/php/modules/fileinfo.so /bref/php-modules/fileinfo.so
RUN cp /opt/remi/php80/root/lib64/php/modules/ftp.so /bref/php-modules/ftp.so
RUN cp /opt/remi/php80/root/lib64/php/modules/gettext.so /bref/php-modules/gettext.so
RUN cp /opt/remi/php80/root/lib64/php/modules/iconv.so /bref/php-modules/iconv.so
RUN cp /opt/remi/php80/root/lib64/php/modules/sockets.so /bref/php-modules/sockets.so
RUN cp /opt/remi/php80/root/lib64/php/modules/tokenizer.so /bref/php-modules/tokenizer.so

# cURL
RUN cp /opt/remi/php80/root/lib64/php/modules/curl.so /bref/php-modules/curl.so
...
# sodium
RUN cp /opt/remi/php80/root/lib64/php/modules/sodium.so /bref/php-modules/sodium.so
...
RUN cp /opt/remi/php80/root/lib64/php/modules/mbstring.so /bref/php-modules/mbstring.so
RUN cp /usr/lib64/libonig.so.105 /bref/lib/libonig.so.105

# mysqli depends on mysqlnd
RUN cp /opt/remi/php80/root/lib64/php/modules/mysqli.so /bref/php-modules/mysqli.so
RUN cp /opt/remi/php80/root/lib64/php/modules/mysqlnd.so /bref/php-modules/mysqlnd.so

#RUN cp /usr/lib64/libsqlite3.so.0 /bref/lib/libsqlite3.so.0
RUN cp /opt/remi/php80/root/lib64/php/modules/sqlite3.so /bref/php-modules/sqlite3.so
...
RUN cp /opt/remi/php80/root/lib64/php/modules/xsl.so /bref/php-modules/xsl.so
...
RUN cp /opt/remi/php80/root/lib64/php/modules/intl.so /bref/php-modules/intl.so

RUN cp /opt/remi/php80/root/lib64/php/modules/apcu.so /bref/php-modules/apcu.so

RUN cp /usr/lib64/libpq.so.5 /bref/lib/libpq.so.5
#RUN cp /usr/lib64/libldap_r-2.4.so.2 /bref/lib/libldap_r-2.4.so.2
RUN cp /opt/remi/php80/root/lib64/php/modules/pdo_pgsql.so /bref/php-modules/pdo_pgsql.so

RUN cp /opt/remi/php80/root/lib64/php/modules/bcmath.so /bref/php-modules/bcmath.so
RUN cp /opt/remi/php80/root/lib64/php/modules/dom.so /bref/php-modules/dom.so
RUN cp /opt/remi/php80/root/lib64/php/modules/opcache.so /bref/php-modules/opcache.so
RUN cp /opt/remi/php80/root/lib64/php/modules/pdo.so /bref/php-modules/pdo.so
RUN cp /opt/remi/php80/root/lib64/php/modules/pdo_mysql.so /bref/php-modules/pdo_mysql.so
RUN cp /opt/remi/php80/root/lib64/php/modules/pdo_sqlite.so /bref/php-modules/pdo_sqlite.so
RUN cp /opt/remi/php80/root/lib64/php/modules/phar.so /bref/php-modules/phar.so
RUN cp /opt/remi/php80/root/lib64/php/modules/posix.so /bref/php-modules/posix.so
RUN cp /opt/remi/php80/root/lib64/php/modules/simplexml.so /bref/php-modules/simplexml.so
RUN cp /opt/remi/php80/root/lib64/php/modules/soap.so /bref/php-modules/soap.so
RUN cp /opt/remi/php80/root/lib64/php/modules/xml.so /bref/php-modules/xml.so
RUN cp /opt/remi/php80/root/lib64/php/modules/xmlreader.so /bref/php-modules/xmlreader.so
RUN cp /opt/remi/php80/root/lib64/php/modules/xmlwriter.so /bref/php-modules/xmlwriter.so
