...
COPY --from=bref/x86-php74-ext-mbstring /opt/php-modules/mbstring.so /opt/php-modules/mbstring.so
...
COPY --from=bref/x86-php74-ext-mysqli /opt/php-modules/mysqli.so /opt/php-modules/mysqli.so
COPY --from=bref/x86-php74-ext-mysqli /opt/php-modules/mysqlnd.so /opt/php-modules/mysqlnd.so
COPY --from=bref/x86-php74-ext-opcache /opt/php-modules/opcache.so /opt/php-modules/opcache.so
