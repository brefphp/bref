...
# PHP Binary
RUN /bin/cat /opt/remi/php80/root/usr/bin/php > /bref/bin/php

RUN chmod +x /bref/bin/php

# Modules
RUN /bin/cat /opt/remi/php80/root/lib64/php/modules/curl.so > /bref/php-modules/curl.so
...
RUN /bin/cat /lib64/libtinfo.so.5 > /bref/lib/libtinfo.so.5 # Amazon Linux 2 only have libtinfo.so.6
...
RUN /bin/cat /opt/remi/php80/root/lib64/php/modules/sodium.so > /bref/php-modules/sodium.so

RUN /bin/cat /opt/remi/php80/root/lib64/php/modules/ctype.so > /bref/php-modules/ctype.so
RUN /bin/cat /opt/remi/php80/root/lib64/php/modules/exif.so > /bref/php-modules/exif.so
RUN /bin/cat /opt/remi/php80/root/lib64/php/modules/fileinfo.so > /bref/php-modules/fileinfo.so
RUN /bin/cat /opt/remi/php80/root/lib64/php/modules/ftp.so > /bref/php-modules/ftp.so
RUN /bin/cat /opt/remi/php80/root/lib64/php/modules/gettext.so > /bref/php-modules/gettext.so
RUN /bin/cat /opt/remi/php80/root/lib64/php/modules/iconv.so > /bref/php-modules/iconv.so
RUN /bin/cat /opt/remi/php80/root/lib64/php/modules/tokenizer.so > /bref/php-modules/tokenizer.so