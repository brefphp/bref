...
# Default Extensions
RUN cp /opt/remi/php74/root/lib64/php/modules/json.so /bref/php-extensions/json.so
RUN cp /opt/remi/php74/root/lib64/php/modules/ctype.so /bref/php-extensions/ctype.so
RUN cp /opt/remi/php74/root/lib64/php/modules/exif.so /bref/php-extensions/exif.so
RUN cp /opt/remi/php74/root/lib64/php/modules/fileinfo.so /bref/php-extensions/fileinfo.so
RUN cp /opt/remi/php74/root/lib64/php/modules/ftp.so /bref/php-extensions/ftp.so
RUN cp /opt/remi/php74/root/lib64/php/modules/gettext.so /bref/php-extensions/gettext.so
RUN cp /opt/remi/php74/root/lib64/php/modules/iconv.so /bref/php-extensions/iconv.so
RUN cp /opt/remi/php74/root/lib64/php/modules/sockets.so /bref/php-extensions/sockets.so
RUN cp /opt/remi/php74/root/lib64/php/modules/tokenizer.so /bref/php-extensions/tokenizer.so

# cURL
RUN cp /opt/remi/php74/root/lib64/php/modules/curl.so /bref/php-extensions/curl.so
...
# sodium
RUN cp /opt/remi/php74/root/lib64/php/modules/sodium.so /bref/php-extensions/sodium.so
...
RUN cp /opt/remi/php74/root/lib64/php/modules/mbstring.so /bref/php-extensions/mbstring.so
RUN cp /usr/lib64/libonig.so.105 /bref/lib/libonig.so.105

# mysqli depends on mysqlnd
RUN cp /opt/remi/php74/root/lib64/php/modules/mysqli.so /bref/php-extensions/mysqli.so
RUN cp /opt/remi/php74/root/lib64/php/modules/mysqlnd.so /bref/php-extensions/mysqlnd.so

#RUN cp /usr/lib64/libsqlite3.so.0 /bref/lib/libsqlite3.so.0
RUN cp /opt/remi/php74/root/lib64/php/modules/sqlite3.so /bref/php-extensions/sqlite3.so
...
RUN cp /opt/remi/php74/root/lib64/php/modules/xsl.so /bref/php-extensions/xsl.so
...
RUN cp /opt/remi/php74/root/lib64/php/modules/intl.so /bref/php-extensions/intl.so

RUN cp /opt/remi/php74/root/lib64/php/modules/apcu.so /bref/php-extensions/apcu.so

RUN cp /usr/lib64/libpq.so.5 /bref/lib/libpq.so.5
#RUN cp /usr/lib64/libldap_r-2.4.so.2 /bref/lib/libldap_r-2.4.so.2
RUN cp /opt/remi/php74/root/lib64/php/modules/pdo_pgsql.so /bref/php-extensions/pdo_pgsql.so

RUN cp /opt/remi/php74/root/lib64/php/modules/bcmath.so /bref/php-extensions/bcmath.so
RUN cp /opt/remi/php74/root/lib64/php/modules/dom.so /bref/php-extensions/dom.so
RUN cp /opt/remi/php74/root/lib64/php/modules/opcache.so /bref/php-extensions/opcache.so
RUN cp /opt/remi/php74/root/lib64/php/modules/pdo.so /bref/php-extensions/pdo.so
RUN cp /opt/remi/php74/root/lib64/php/modules/pdo_mysql.so /bref/php-extensions/pdo_mysql.so
RUN cp /opt/remi/php74/root/lib64/php/modules/pdo_sqlite.so /bref/php-extensions/pdo_sqlite.so
RUN cp /opt/remi/php74/root/lib64/php/modules/phar.so /bref/php-extensions/phar.so
RUN cp /opt/remi/php74/root/lib64/php/modules/posix.so /bref/php-extensions/posix.so
RUN cp /opt/remi/php74/root/lib64/php/modules/simplexml.so /bref/php-extensions/simplexml.so
RUN cp /opt/remi/php74/root/lib64/php/modules/soap.so /bref/php-extensions/soap.so
RUN cp /opt/remi/php74/root/lib64/php/modules/xml.so /bref/php-extensions/xml.so
RUN cp /opt/remi/php74/root/lib64/php/modules/xmlreader.so /bref/php-extensions/xmlreader.so
RUN cp /opt/remi/php74/root/lib64/php/modules/xmlwriter.so /bref/php-extensions/xmlwriter.so
