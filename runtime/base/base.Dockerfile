...
# libwebp-devel : needed for gd with WebP support
...
RUN LD_LIBRARY_PATH= yum install -y readline-devel gettext-devel libicu-devel libpng-devel libjpeg-devel libwebp-devel libxslt-devel ImageMagick-devel sqlite-devel
