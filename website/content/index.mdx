...
import { LaravelFullIcon } from '../src/components/icons/LaravelFullIcon';
import { SymfonyFullIcon } from '../src/components/icons/SymfonyFullIcon';
import styles from './index.module.css';
import CaseStudies from '../src/components/home/case-studies';
import Testimonials from '../src/components/home/testimonials';
import Invocations from '../src/components/home/invocations';
        ...
        <div className="px-6 lg:px-0 lg:pt-6">
            <div className="mx-auto max-w-2xl">
                <div className="max-w-lg">
                    <h1 className="text-4xl font-black leading-tight tracking-tight text-gray-900 sm:text-5xl sm:leading-tight">Simple and scalable PHP with <span className="text-blue-500">serverless</span></h1>
                    ...
                    <div className="mt-10 flex items-center gap-x-6">
                        ...
                        <a href="https://github.com/brefphp/bref"
                           className="px-3.5 py-2.5 text-sm font-semibold leading-6 text-gray-900">View on GitHub <span aria-hidden="true">→</span></a>
                    </div>
