...
seoTitle: "Bref 3.0 is released 🎉"
description: "Bref 3.0 is released and reaches 40 billion invocations every month."
ogImage: "https://bref.sh/news/03-social-card.png"
---
...
functions:
    api:
        # ...
        layers:
            - ${bref-extra:redis-php-84} # remove this line
```
...
```ini filename="php/conf.d/php.ini" {1}
extension=pdo_pgsql ; remove this line
```
...
- **If you deploy using container images**: you need to update your `Dockerfile`, ⚠️ read the [upgrade guide](../docs/upgrading/v3.mdx#container-image-changes).
