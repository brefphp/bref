...
No more installing the extension separately, it just works!

If you were using the Redis extension from [bref/extra-php-extensions](https://github.com/brefphp/extra-php-extensions), you can remove it from your `serverless.yml`:
...
If Redis was the only extra extension you were using, you can uninstall the package entirely:
