            ...
            <div className="relative isolate overflow-hidden bg-white">
                ...
                <div className="mx-auto max-w-7xl py-20 lg:py-24 px-6 lg:px-8">
                    <div className="mx-auto max-w-2xl text-center">
                        ...
                        <p className="mt-6 text-pretty leading-7 text-lg text-gray-600 max-w-2xl mx-auto">
                        ...
                        <p className="mt-3 text-pretty leading-7 text-lg text-gray-600 max-w-2xl mx-auto">
