...
<NextSeo
    title="Bref Cloud - Professional PHP hosting on AWS Lambda - powerful, scalable, simple"
                ...
                <div className="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-32">
                    <div className="mx-auto max-w-2xl lg:mx-0 lg:shrink-0 lg:pt-8">
                        <h1 className="mt-10 text-pretty text-4xl sm:text-5xl font-black tracking-tight text-gray-900">
                            <span className="text-blue-500">Serverless</span> PHP made simple,
                            <br/>
                            with everything included
                        </h1>
                        <p className="mt-8 text-pretty leading-7 text-lg text-gray-600 max-w-lg">
                            Get the reliability and scalability of
                            AWS and Lambda without having to become an AWS expert.
                        </p>
                        ...
                        <p className="mt-3 text-pretty leading-7 text-lg text-gray-600 max-w-lg">
                            Bref Cloud makes it all <strong>accessible and simple</strong> with expert support built-in.
                        </p>
