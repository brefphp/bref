        ...
        <div className="bg-white py-24 sm:py-32">
            <div className="mx-auto max-w-2xl px-6 lg:max-w-4xl lg:px-8">
                ...
                <div className="mt-16 relative w-full aspect-video text-gray-700 font-semibold text-sm">
                    ...
                    {/* Icons */}
                    <div className="absolute top-0 left-0 h-36 w-40 flex flex-col items-center justify-center gap-3 bg-white shadow ring-1 ring-gray-100 rounded-2xl">
                        <Image src={brefCloudIcon} alt="Bref Cloud" className="size-16" />
                        <div>bref.cloud</div>
                    </div>
                    <div className="absolute top-0 right-0 h-36 w-40 flex flex-col items-center justify-center gap-3 bg-white shadow ring-1 ring-gray-100 rounded-2xl">
                        <Image src={awsIcon} alt="AWS" className="size-16" />
                        <div>Your AWS account</div>
                    </div>
                    <div className="absolute bottom-0 left-0 h-36 w-40 flex flex-col items-center justify-center gap-3 bg-white shadow ring-1 ring-gray-100 rounded-2xl">
                    ...
                    <div className="absolute bottom-0 right-0 h-36 w-40 flex flex-col items-center justify-center gap-3 bg-white shadow ring-1 ring-gray-100 rounded-2xl">
