...
Name: `php-85-fpm`, `php-84-fpm`, `php-83-fpm`, `php-82-fpm`, `php-81-fpm`, and `php-80-fpm`.
...
Name: `php-85`, `php-84`, `php-83`, `php-82`, `php-81`, and `php-80`.
...
Name: `php-85-console`, `php-84-console`, `php-83-console`, `php-82-console`, `php-81-console`, and `php-80-console`.
...
Bref currently provides runtimes for PHP 8.0, 8.1, 8.2, 8.3, 8.4 and 8.5:
