...
Bref is designed out of the box to deploy using [the Serverless Framework](https://github.com/oss-serverless/serverless).

Bref can also work with any other deployment tool: Terraform, CloudFormation, SAM, [AWS CDK](https://github.com/brefphp/constructs), Pulumi… However, the documentation and user experience are optimized for Serverless Framework.
