...
<Cards>
    <Card icon="🚀 " title="Get started with Laravel" href="/docs/laravel/getting-started" />
    <Card icon="🚀 " title="Get started with Symfony" href="/docs/symfony/getting-started" />
    <Card icon="🚀 " title="Get started with other frameworks" href="/docs/default/getting-started" />
</Cards>
