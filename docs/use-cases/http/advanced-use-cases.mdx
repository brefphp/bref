...
You can look at more advanced API Gateway routing options in the [serverless documentation](https://github.com/oss-serverless/osls/blob/4.x/docs/events/http-api.md).
...
You can deploy a Lambda Function URL [via the following configuration](https://github.com/oss-serverless/osls/blob/4.x/docs/guides/functions.md#lambda-function-urls):
...
Learn more [in the Serverless Framework documentation](https://github.com/oss-serverless/osls/blob/4.x/docs/events/apigateway.md).
...
Learn more [in the Serverless Framework documentation](https://github.com/oss-serverless/osls/blob/4.x/docs/events/alb.md).
...
[Full reference of HTTP events in `serverless.yml`](https://github.com/oss-serverless/osls/blob/4.x/docs/events/http-api.md).
