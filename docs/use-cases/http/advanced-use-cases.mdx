...
You can look at more advanced API Gateway routing options in the [serverless documentation](https://github.com/oss-serverless/serverless/blob/main/docs/events/http-api.md).
...
You can deploy a Lambda Function URL [via the following configuration](https://github.com/oss-serverless/serverless/blob/main/docs/guides/functions.md#lambda-function-urls):
...
Learn more [in the Serverless Framework documentation](https://github.com/oss-serverless/serverless/blob/main/docs/events/apigateway.md).
...
Learn more [in the Serverless Framework documentation](https://github.com/oss-serverless/serverless/blob/main/docs/events/alb.md).
...
| Is each request handled in a separate PHP process? | Yes (that's how PHP-FPM works).                                                                                                | Yes by default (Bref replicates that to avoid surprises) but can be disabled for optimal performance.                  |
...
[Full reference of HTTP events in `serverless.yml`](https://github.com/oss-serverless/serverless/blob/main/docs/events/http-api.md).
...
On applications with regular traffic, cold starts only represent about **0.2% of requests**. For low-traffic applications, you can pre-warm your HTTP function to avoid them.
