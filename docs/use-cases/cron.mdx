...
Read more about the options for the `schedule` event in the [Serverless documentation](https://github.com/oss-serverless/osls/blob/4.x/docs/events/schedule.md).
