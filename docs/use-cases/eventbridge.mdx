...
Learn more about all the options available for EventBridge in `serverless.yml` [in the Serverless Framework documentation](https://github.com/oss-serverless/osls/blob/4.x/docs/events/event-bridge.md).
