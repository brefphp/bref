...
To send a message to a connected client, you can use the [bref/api-gateway-websocket-client library](https://github.com/brefphp/api-gateway-websocket-client) to make an HTTP request to the endpoint provided by AWS.

Learn more about using WebSockets in `serverless.yml` [in the Serverless Framework documentation](https://github.com/oss-serverless/serverless/blob/main/docs/events/websocket.md).
