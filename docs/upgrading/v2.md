---
description: Upgrading guide to go from Bref 1.x to Bref 2.0.
---
...
The `bref/php-XX-fpm-dev` images can now run HTTP applications, console commands as well as event-driven functions too. Read more in [web app local development](../local-development.mdx).
