...
functions:
    worker:
        ...
        runtime: php-84
        events:
            # Read more at https://github.com/oss-serverless/osls/blob/4.x/docs/events/sns.md
            - sns:
...
functions:
    worker:
        ...
        runtime: php-84
        events:
            # Read more at https://github.com/oss-serverless/osls/blob/4.x/docs/events/event-bridge.md
            -   eventBridge:
