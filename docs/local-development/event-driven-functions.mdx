...
If you build HTTP applications with [API Gateway HTTP events](/docs/runtimes/fpm-runtime.mdx), `serverless bref:local` is a bit impractical because you need to manually craft HTTP events in JSON.
