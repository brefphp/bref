...
Bref Cloud accesses your AWS accounts to deploy and manage resources like AWS Lambda.

This document explains how Bref Cloud accesses these AWS accounts securely.
