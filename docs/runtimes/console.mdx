---
description: "Learn how to run serverless console commands on AWS Lambda with Symfony Console or Laravel Artisan."
---
...
### From the Bref Cloud dashboard

As an alternative to the CLI, [Bref Cloud](/cloud) lets you run commands on a deployed environment directly from the dashboard.
