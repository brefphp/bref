---
description: "Learn how to run serverless HTTP applications with PHP on AWS Lambda using Bref."
---
...
The request ID of the invocation is also available directly in `$_SERVER['LAMBDA_REQUEST_ID']`, like in [the other runtimes](./runtimes-details.mdx#environment-variables).
