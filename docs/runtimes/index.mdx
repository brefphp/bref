...
The `${...}` notation is the [syntax to use variables](https://github.com/oss-serverless/serverless/blob/main/docs/guides/variables.md) in `serverless.yml`. The Bref plugin provides the following variables:
