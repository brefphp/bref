...
A PHP function can be triggered manually from the CLI using the [`serverless invoke` command](https://github.com/oss-serverless/osls/blob/4.x/docs/cli-reference/invoke.md):
