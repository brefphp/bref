...
[Plans](https://planetscale.com/pricing) start at $5/month for single-node PostgreSQL databases.
...
You want each "stage" of our application to connect to a different PlanetScale branch. You can achieve that in `serverless.yml` via [stage parameters](https://github.com/oss-serverless/serverless/blob/main/docs/guides/parameters.md#stage-parameters):
