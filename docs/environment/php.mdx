...
<ul className="grid grid-cols-2 md:grid-cols-3">
    ...
    <li><a className="underline" href="https://www.php.net/manual/en/intro.ctype.php">ctype</a></li>
...
- **[intl](https://www.php.net/manual/en/intro.intl.php)** - Internationalization extension (referred to as Intl) is a wrapper for ICU library, enabling PHP programmers to perform various locale-aware operations.
