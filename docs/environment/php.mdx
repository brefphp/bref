...
<ul className="grid grid-cols-2 md:grid-cols-3">
    <li>Core</li>
    <li><a className="underline" href="http://php.net/manual/en/book.bc.php">bcmath</a></li>
    <li><a className="underline" href="http://php.net/manual/en/intro.ctype.php">ctype</a></li>
    <li><a className="underline" href="http://php.net/manual/en/book.curl.php">curl</a></li>
    <li>date</li>
    <li><a className="underline" href="http://php.net/manual/en/book.dom.php">dom</a></li>
    <li><a className="underline" href="http://php.net/manual/en/book.exif.php">exif</a></li>
    <li><a className="underline" href="http://php.net/manual/en/book.fileinfo.php">fileinfo</a></li>
    <li><a className="underline" href="http://php.net/manual/en/book.filter.php">filter</a></li>
    <li><a className="underline" href="http://php.net/manual/en/book.ftp.php">ftp</a></li>
    <li><a className="underline" href="http://php.net/manual/en/book.gettext.php">gettext</a></li>
    <li><a className="underline" href="http://php.net/manual/en/book.hash.php">hash</a></li>
    <li><a className="underline" href="http://php.net/manual/en/book.iconv.php">iconv</a></li>
    <li><a className="underline" href="http://php.net/manual/en/book.json.php">json</a></li>
    <li><a className="underline" href="http://php.net/manual/en/book.libxml.php">libxml</a></li>
    <li><a className="underline" href="http://php.net/manual/en/book.mbstring.php">mbstring</a></li>
    <li><a className="underline" href="http://php.net/manual/en/book.mysqli.php">mysqli</a></li>
    <li><a className="underline" href="http://php.net/manual/en/book.mysqlnd.php">mysqlnd</a></li>
    <li><a className="underline" href="http://php.net/manual/en/book.opcache.php">opcache</a></li>
    <li><a className="underline" href="http://php.net/manual/en/book.openssl.php">openssl</a></li>
    <li><a className="underline" href="http://php.net/manual/en/book.pcntl.php">pcntl</a></li>
    <li><a className="underline" href="http://php.net/manual/en/book.pcre.php">pcre</a></li>
    <li><a className="underline" href="http://php.net/manual/en/book.pdo.php">PDO</a></li>
    <li><a className="underline" href="http://php.net/manual/en/ref.pdo-sqlite.php">pdo_sqlite</a></li>
    <li><a className="underline" href="http://php.net/manual/en/ref.pdo-mysql.php">pdo_mysql</a></li>
    <li><a className="underline" href="http://php.net/manual/en/book.phar.php">Phar</a></li>
    <li><a className="underline" href="http://php.net/manual/en/book.posix.php">posix</a></li>
    <li><a className="underline" href="http://php.net/manual/en/book.readline.php">readline</a></li>
    <li><a className="underline" href="http://php.net/manual/en/book.reflection.php">Reflection</a></li>
    <li><a className="underline" href="http://php.net/manual/en/book.session.php">session</a></li>
    <li><a className="underline" href="https://php.net/manual/en/book.simplexml.php">SimpleXML</a></li>
    <li><a className="underline" href="http://php.net/manual/en/book.sodium.php">sodium</a></li>
    <li><a className="underline" href="http://php.net/manual/en/book.soap.php">SOAP</a></li>
    <li><a className="underline" href="http://php.net/manual/en/book.sockets.php">sockets</a></li>
    <li><a className="underline" href="http://php.net/manual/en/book.spl.php">SPL</a></li>
    <li><a className="underline" href="http://php.net/manual/en/book.sqlite3.php">sqlite3</a></li>
    <li><a className="underline" href="http://php.net/manual/en/book.tokenizer.php">tokenizer</a></li>
    <li><a className="underline" href="http://php.net/manual/en/book.xml.php">xml</a></li>
    <li><a className="underline" href="http://php.net/manual/en/book.xmlreader.php">xmlreader</a></li>
    <li><a className="underline" href="http://php.net/manual/en/book.xmlwriter.php">xmlwriter</a></li>
    <li><a className="underline" href="http://php.net/manual/en/book.xsl.php">xsl</a></li>
    <li><a className="underline" href="http://php.net/manual/en/book.zlib.php">zlib</a></li>
</ul>
