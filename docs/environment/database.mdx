...
Put these information in `serverless.yml` in your function configuration ([read more about this in the Serverless documentation](https://github.com/oss-serverless/serverless/blob/main/docs/guides/functions.md#vpc-configuration)):
