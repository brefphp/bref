---
description: "How to create AWS access keys for Bref"
---


# Creating AWS access keys

To create AWS access keys for Bref and the `serverless` CLI tool follow these steps:
